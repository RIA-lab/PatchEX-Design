...
class PSI(nn.Module):
    def __init__(self, args, vocab_size, embed_dim, hidden_dim, seq_len):
        ...
        self.pas_decoder = TargetDecoder(hidden_dim, kernel_size=3)
    ...
    def pas_decode(self, y):
        y = self.pas_decoder(y)
        return y

    def fitness_decode(self, y):
        return self.pas_decode(y)
