...
class Model(nn.Module):
    def __init__(self, config):
        ...
        if config['pretrained_patchet'] is not None and config['pretrained_patchet'].endswith('yaml'):
            patchet_pretrained_config = load_config(config['pretrained_patchet'])
        ...
        elif config['pretrained_patchet'] is not None:
